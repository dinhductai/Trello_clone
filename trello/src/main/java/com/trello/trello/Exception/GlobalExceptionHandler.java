...
import com.trello.trello.Exception.ModelException.ErrorDetail;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetail> handleAllExceptions(Exception ex, WebRequest request){
        ErrorDetail errorDetail = new ErrorDetail(LocalDateTime.now(),"An error occurred :"+ex.getMessage(),"check this uri :"+request.getDescription(false));
